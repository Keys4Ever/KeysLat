    ...
    return (
        <div className={`flex items-center gap-2 border p-2 whitespace-nowrap cursor-pointer ${isSelected ? "bg-white text-black" : "border-white text-white"}`}>
            ...
            <div className="flex items-center gap-1">
                <button className="p-1 hover:bg-white cursor-pointer hover:text-black transition" onClick={() => handleEditTag(tag)}>
                    <Edit className="w-4 h-4" />
                </button>
                <button className="p-1 hover:bg-white cursor-pointer hover:text-black transition" onClick={handleDelete}>
                    <X className="w-4 h-4" />
                </button>
            </div>
        </div>
